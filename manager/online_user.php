...
$q="insert into online_user(bet_id,deposit,cashier_id,shop,date)  values('$betid','$amount','$cid','$shop','$date')" ;
mysqli_query($con,$q);

if($q){
$_SESSION['msg2']="Online User inserted Successfully !!!";
}
else
{
...
<html lang="en">
	<head>
		<title>Manager  | Online User</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Manager | Online User</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Manager</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Online User</h5>
												</div>
