				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Manager | Customer PayOut</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Manager</span>
...
$bid=$con->prepare("select bet_id from sport_win where cashier_id = ?  order by id desc");
$bid->bind_param('s',$cashier_id);
$bid->execute();
$bid->store_result();
