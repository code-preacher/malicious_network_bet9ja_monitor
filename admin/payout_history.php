				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | PayOut History</h1>
																	</div>
...
$sql2=mysqli_query($con,"select * from payout  order by id desc");
...
?>
											...
											<tr>
												...
												<td>		
	<a href="delete.php?bet_id_p=<?php echo $row['bet_id'] ; ?>" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove">Remove</a>
												</td>
