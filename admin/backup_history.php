...
<html lang="en">
	<head>
		<title>Admin | Backup History</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | Backup History</h1>
																	</div>
...
$sql2=mysqli_query($con,"select * from backups  order by id desc");
...
?>
											...
											<tr>
												...
												<td>		
	<a href="delete.php?bet_id_b=<?php echo $row['bet_id'] ; ?>" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove">Remove</a>
												</td>
